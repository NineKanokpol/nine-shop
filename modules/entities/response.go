...
import (
	"github.com/NineKanokpol/Nine-shop-test/pkg/ninelogger"
...
func (r *Response) Success(code int, data any) IResponse {
	r.StatusCode = code
	r.Data = data
	ninelogger.InitNineLogger(r.Context, &r.Data).Print().Save()
	return r
}
...
func (r *Response) Error(code int, traceId, msg string) IResponse {
	...
	r.IsError = true
	ninelogger.InitNineLogger(r.Context, &r.ErrorRes).Print().Save()
	return r
}
